...
nlp = English()
json_comment_name='input_json/101373961279443806744.json'
caption = json.load(open('input_json/cap_101373961279443806744.json'))
comment = json.load(open(json_comment_name))
obj={}
data=[]
counter_total_elemt=0
with open('output/comment_caption_101373961279443806744.json','w') as jfile:
